pipeline {
  ...
  environment {
    ...
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-wacey6fc96h3'
    // If there are functions with "Image" PackageType in your template,
    // uncomment the line below and add "--image-repository ${TESTING_IMAGE_REPOSITORY}" to
    // testing "sam package" and "sam deploy" commands.
    // TESTING_IMAGE_REPOSITORY = '0123456789.dkr.ecr.region.amazonaws.com/repository-name'
    TESTING_REGION = 'us-east-1'
    PROD_STACK_NAME = 'sam-resumeChallenge-prod-app'
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::008556789497:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-NDTHBJA02S1Z'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::008556789497:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-TISNUO0100GQ'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-ti8ydlgmmr42'
    // If there are functions with "Image" PackageType in your template,
